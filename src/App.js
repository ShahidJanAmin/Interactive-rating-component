...
function App() {
  ...
  return (
    <div className='container-fluid'>
      {
        submit.sub == false ? <div className='col-md-7 col-sm-10'>
          <div className='card'>
            <div className='card-header'>
              <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16"><path d="m9.067.43 1.99 4.031c.112.228.33.386.58.422l4.45.647a.772.772 0 0 1 .427 1.316l-3.22 3.138a.773.773 0 0 0-.222.683l.76 4.431a.772.772 0 0 1-1.12.813l-3.98-2.092a.773.773 0 0 0-.718 0l-3.98 2.092a.772.772 0 0 1-1.119-.813l.76-4.431a.77.77 0 0 0-.222-.683L.233 6.846A.772.772 0 0 1 .661 5.53l4.449-.647a.772.772 0 0 0 .58-.422L7.68.43a.774.774 0 0 1 1.387 0Z" fill="#FC7614" /></svg>
            </div>
            ...
            <button className='SubmitBtn' onClick={() => setSubmit({ sub: true })}>Submit</button>
          </div>
        </div>
        </div>
        ...
        <div className="card-submit">
          <svg xmlns="http://www.w3.org/2000/svg" width="162" height="108">
            <g fill="none">
              ...
              <path fill="#39475F" d="M119.847 100.221H58.146L70.332.793h55.025l5.747 7.601z" /><path fill="#61728D" d="M113.172 100.221H51.465L63.651.793h61.706z" /><path fill="#181F27" d="M110.132 81.354H58.576l8.791-71.695h51.557z" />
              <path fill="#1E252E" d="m92.743 50.055 14.897.177-.29 2.308-14.607-.252z" /><path fill="#39475F" d="m51.465 100.221 7.422 6.864 60.037.915.923-7.779z" />
              ...
              <path fill="#2D394B" d="m78.21 14.834-.918 6.041h26.621l.806-6.041z" /><path d="M85.54 86.19c-2.872-2.517-7.416-2.022-9.446 1.222a4.955 4.955 0 0 0-.8 2.647c0 3.98 2.744 6.59 8.227 5.492 4.184-.839 5.779-6.073 2.02-9.36Z" fill="#FFF" opacity=".48" />
